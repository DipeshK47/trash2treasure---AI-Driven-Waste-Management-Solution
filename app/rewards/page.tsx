        ...
        <div className="min-h-screen bg-gradient-to-b from-green-100 to-white p-8">
            <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-serif text-gray-500">Available Points</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div>
                        <h2 className="text-2xl font-semibold font-serif mb-4 text-gray-800">Recent Transactions</h2>
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold font-serif mb-4 text-gray-800">Available Rewards</h2>
